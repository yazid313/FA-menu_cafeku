        ...
        <div className="flex  justify-between relative ">
          ...
          <div className="flex  w-full ">
            ...
            <nav
              ...
              className={` ${
                isOpen ? "" : "hidden"
              } absolute p-5 md:p-0 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-11 md:block md:static md:bg-transparent md:max-w-full md:shadow-none md:rounded-none`}
            >
