        ...
        <>
          ...
          <div className="flex flex-wrap justify-between items-center lg:w-full gap-4 md:gap-6 w-full mb-6">
            <div className="flex gap-3 items-center ">
              ...
              <button
                onClick={searchData}
                className="body-text-sm-bold font-nunitoSans px-4 py-2 md:px-5 md:py-3 h-[40px] md:h-[48px] bg-yellow-700 rounded-md shadow-md hover:bg-yellow-600 transition-all duration-300"
              >
                Cari
              </button>
            </div>
                  ...
                  searchQuery.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">{item.outlet_name}</td>
